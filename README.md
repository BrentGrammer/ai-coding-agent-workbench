...
This project runs Claude Code, Codex, and OpenCode in [Herdr](https://herdr.dev/) beside [Hunk](https://www.hunk.dev/). It supports running locally with `sbx` Docker sandbox MicroVMs and in the Cloud using [AWS Bedrock AgentCore](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/agentcore-get-started-cli.html).
